...
function setConnectionStatus(isOnline) {
    var statusLabel = document.getElementById("clusterStatusLabel");
    if (isOnline) {
...
document.getElementById("connectToClusterButton").addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
    var regexRes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                regexRes = /^(http|https):\/\/(([0-9]|[0-9][0-9\-]*[0-9])\.)*([0-9]|[0-9][0-9\-]*[0-9])(:[0-9]+)$/;
                if (!regexRes.test(ip)) return [3 /*break*/, 2];
                client = new Client({ node: ip, requestTimeout: 500 });
                return [4 /*yield*/, client.ping({}, function (e) {
                        if (e) {
